open util/ordering[DshSnapshot] as aldb_order
...
fact { dsh_initial[aldb_order/first] }

fact { all s: DshSnapshot, sprime: s.(aldb_order/next) { dsh_small_step[s, sprime] } }

run {  } for exactly 1 DshSnapshot